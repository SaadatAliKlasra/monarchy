      ...
      <div className="benefit-list__item">
        ...
        <Collapse in={activeListItem === 1}>
          <p className="subtitle-sm fw-m">
            ...
            provides comprehensive roofing, siding, and HVAC services by
            providing you with a Royally-Certified™ Contractor as your one point
            of communication for the entirety of your project. We are dedicated
            to providing the quality craftsmanship our clients expect, from the
      ...
      <div className="benefit-list__item">
        ...
        <Collapse in={activeListItem === 2}>
          <p className="subtitle-sm fw-m">
            ...
            our roofing, siding, and HVAC projects entirely in-house. Every
            detail of your project from material selection to construction is
            completed by our experienced and fully licensed Royally-Certified™
            Contractors. With all aspects of a project completed under our roof,
            we can assure our clients quality building services where our
            competition can’t. Our royal touch ensures that even the smallest
            detail is up to our highest standards.
          </p>
        </Collapse>
      </div>
      <div className="benefit-list__item">
      ...
      <div className="benefit-list__item">
        ...
        <Collapse in={activeListItem === 5}>
          <p className="subtitle-sm fw-m">
            ...
            profit from change orders or hidden fees. Start by getting an
            instant price by answering a few questions about your roofing,
            siding, or HVAC project. You will immediately receive a free,
            all-inclusive estimate with a breakdown of our costs. Our fully
            licensed Royally-Certified Contractor will then meet with you to
            confirm your price and walk you through our process.
          </p>
        </Collapse>
      </div>
      <div className="benefit-list__item">
        ...
        <Collapse in={activeListItem === 6}>
          <p className="subtitle-sm fw-m">
            ...
            find a better estimate by a reputable roofing, siding, or HVAC
            company in Ottawa, we'll pass along the savings to you.
          </p>
        </Collapse>
      </div>
    </ul>
